...
namespace MixedReality.Toolkit.UX
{
    ...
    public class MyDialog : MonoBehaviour, IDialog
    {
        ...
        public void SetNeutralLabel(string label) {
            neutralButton.Label.text = label;
        }
        ...
        protected virtual void Awake()
        {
            if (negativeButton.Interactable != null)
            {
                negativeButton.Interactable.OnClicked.AddListener( () => {
                    ...
                    //Dismiss();                            // MODIFICA: commentata questa riga se no i pulsanti chiudono sempre il pannello
                });
            }
        ...
        public virtual void Dismiss()
        {
            ...
            //StartCoroutine(InvokeDismissalAfterAnimation());      // animazione dismiss
